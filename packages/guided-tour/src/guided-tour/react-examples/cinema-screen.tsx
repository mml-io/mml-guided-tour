...
export const CinemaScreen = memo(({ x, y, z, sx, sy, sz, ry, visibleTo }: CinemaScreenProps) => {
  ...
  const videoRef = useRef<MVideoElement | null>(null);
  const volumeOnRef = useRef<MImageElement | null>(null);
  const volumeOffRef = useRef<MImageElement | null>(null);
